                  ...
                  <BreadcrumbsCustom>
                    {id ? (
                      <>
                        ...
                        <StyledBreadcrumb
                          label={
                            report.category[report.category.length - 1].name
                          }
                          component={Link}
                          to={`/reports/category/${
                            report.category[report.category.length - 1]._id
                          }`}
                        />
                        <StyledBreadcrumb label={report.title} />
                      </>
                    ) : (
                      <StyledBreadcrumb label="گزارش تصویری" />
                    )}
                  </BreadcrumbsCustom>
                  <Card className="mt-3">
                    <Card.Body>
                      <Row>
                        ...
                        <Row>
                          <Col xs={12}>
                            <h6>توضیحات : </h6>
                            <p className="fs-7">{report?.text || ""}</p>
                          </Col>
                        </Row>
