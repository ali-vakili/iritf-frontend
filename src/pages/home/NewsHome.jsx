      ...
      {data && data.news.length > 0 ? (
        <div className="my-3">
                  ...
                  <Row>
                    <Col md={4}>
                      <Card.Img
                        ...
                        alt={firstNews.title}
                        style={
                          firstNews.imagesURL === undefined &&
                          firstNews.imageURL === undefined
                            ? {
                                width: "100%",
                                height: "100%",
                                objectFit: "cover",
                    ...
                    <Col md={8} className="pe-md-4">
                      <h5 className="pt-3 mb-3">{firstNews.title}</h5>
          ...
          <div className="news-list px-md-3 mt-4">
            <Row>
              <Col md={6}>
                {firstFourNews !== undefined &&
                  firstFourNews.map((news) => (
              ...
              <Col md={6}>
                {SecondFourNews !== undefined &&
                  SecondFourNews.map((news) => (
                    <Link to={`news/${news._id}`}>
                      <div className="news">
                        <img
                          src={
