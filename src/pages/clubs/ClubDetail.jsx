                    ...
                    {id ? (
                      <>
                        ...
                        <StyledBreadcrumb
                          ...
                          component={Link}
                          to={`/clubs/category/${
                            club.category[club.category.length - 1]._id
                          }`}
                        />
                        <StyledBreadcrumb label={club.title} />
                      </>
                    ) : (
                      <StyledBreadcrumb label="باشگاه" />
                    )}
                  </BreadcrumbsCustom>
                  <Card className="mt-3">
